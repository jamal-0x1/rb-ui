  ...
  return (
    <div className="group rounded-lg bg-white shadow-1">
      <div className="flex flex-col sm:flex-row">
        <div className="shadow-list relative overflow-hidden flex items-center justify-center w-full sm:max-w-[270px] min-h-[270px] sm:min-h-[270px] p-4 shrink-0">
        ...
        <div className="w-full flex flex-col gap-5 sm:flex-row sm:items-center justify-center sm:justify-between py-5 px-4 sm:px-7.5 lg:pl-11 lg:pr-12">
          <div>
            ...
            {item.shortDescription && (
              <p className="text-sm text-dark-4 mb-2 line-clamp-2 max-w-md">
                {item.shortDescription}
              </p>
            )}
